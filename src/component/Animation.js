...
import Points from "./shared/Point";
            ...
            <div className={"bg-svg"}>
                ...
                <div id={"svg-logo"}>
                    <svg className={"svg-logo"} viewBox={"0 0 100 100"}>
                        ...
                        <Logo logoOuter={this.state.logoOuter} logoPath={this.state.logoPath} logoPoint={this.state.logoCircle} logoTextZero={this.state.logoTextZero} logoText={this.state.logoText} />
                    </svg>
                </div>
            </div>
        );
