                        ...
                        <div className="form-content">
                            <div className="form-ppp-fname">
                                <div className="form-ppp-label">
                                    <label htmlFor="ppp-fname-input">First Name</label>
                                </div>
                            ...
                            <div className="form-ppp-email">
                                <div className="form-ppp-label">
                                    <label htmlFor="ppp-email-input">Email Id</label>
                                </div>
                                <div className="form-ppp-input">
                            ...
                            <div className="form-ppp-phone">
                                <div className="form-ppp-label">
                                    <label htmlFor="ppp-phone-input">Phone Number</label>
                                </div>
                                <div className="form-ppp-input">
                            ...
                            <div className="form-ppp-DOB">
                                <div className="form-ppp-label">
                                    <label htmlFor="ppp-DOB-input">Date Of Birth</label>
                                </div>
                                <div className="form-ppp-input">
                            ...
                            <div className="form-ppp-country">
                                <div className="form-ppp-label">
                                    <label htmlFor="ppp-country-select">Country</label>
                                </div>
                            ...
                            <div className="form-ppp-institution">
                                <div className="form-ppp-label">
                                    <label htmlFor="ppp-institution-select">Institution</label>
                                </div>
                                <div className="form-ppp-input"> {/* make a selection input */}
                                    <input type="text" id="ppp-institution-select" name="ppp-institution" class="ppp-institution" placeholder="Institution" />
                                </div>
                            </div>

                            {/* <div className="form-ppp-job-role">
                                <div className="form-ppp-label">
                                    <label htmlFor="ppp-job-role-input">Job Role</label>
                                </div>
                                <div className="form-ppp-input">
                                    <input id="ppp-job-role-input" name="ppp-job-role" type="text" placeholder="Job Role" />
                                </div>
                            </div> */}

                            <div className="form-ppp-project-type">
                                <div className="form-ppp-label">
                                    <label htmlFor="ppp-project-type-select">Project Type</label>
                                </div>
                                <div className="form-ppp-input"> {/* make a selection input */}
                            ...
                            <div className="form-ppp-github-link">
                                <div className="form-ppp-label">
                                    <label htmlFor="ppp-github-link-input">Github Profile</label>
                                </div>
                                <div className="form-ppp-input"> 
                            ...
                            <div className="form-ppp-linkedin-link">
                                <div className="form-ppp-label">
                                    <label htmlFor="ppp-linkedin-link-input">LinkedIn Profile</label>
                                </div>
                                <div className="form-ppp-input"> 
